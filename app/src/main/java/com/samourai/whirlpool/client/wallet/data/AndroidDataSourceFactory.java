...
public class AndroidDataSourceFactory implements DataSourceFactory {
    ...
    public AndroidDataSourceFactory(PushTx pushTx, FeeUtil feeUtil, UTXOFactory utxoFactory, BIP47Util bip47Util, BIP47Meta bip47Meta, WalletSupplier walletSupplier, ChainSupplier chainSupplier) {
        this.pushTx = pushTx;
    ...
    public DataSource createDataSource(WhirlpoolWallet whirlpoolWallet, HD_Wallet bip44w, String passphrase, WalletStateSupplier walletStateSupplier, UtxoConfigSupplier utxoConfigSupplier) throws Exception {
        return new AndroidDataSource(whirlpoolWallet, pushTx, feeUtil, utxoFactory, bip47Util, bip47Meta, walletSupplier, utxoConfigSupplier, chainSupplier);
    }
}
