...
public class PayNymRestoreActivity extends SamouraiActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edPayNym.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction() == MotionEvent.ACTION_UP && event.getRawX() >= (edPayNym.getRight() - edPayNym.getCompoundDrawables()[DRAWABLE_RIGHT].getBounds().width())) {
                    ...
                    final ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(PayNymRestoreActivity.this, android.R.layout.select_dialog_singlechoice);
                    for(int i = 0; i < entries.size(); i++)   {
                        arrayAdapter.add(BIP47Meta.getInstance().getDisplayLabel(entries.get(i)));
                    }

                    AlertDialog.Builder dlg = new AlertDialog.Builder(PayNymRestoreActivity.this);
        ...
        btOK.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if(pcode == null)    {
                    Toast.makeText(PayNymRestoreActivity.this, R.string.invalid_payment_code, Toast.LENGTH_SHORT).show();
                    return;
                }

                if(strIndex == null || strIndex.length() < 1)   {
                    Toast.makeText(PayNymRestoreActivity.this, R.string.invalid_index, Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                try {
                    ...
                    message += "\n";
                    message += "\n";
                    message += PayNymRestoreActivity.this.getText(R.string.receive_addresses).toString() + ":";
                    message += "\n";
                    ...
                    message += "\n";
//                    message += PayNymRestoreActivity.this.getText(R.string.send_addresses).toString() + ":";
//                    message += "\n";
...
//                    message += "\n";
                    ...
                    AlertDialog.Builder dlg = new AlertDialog.Builder(PayNymRestoreActivity.this)
                            ...
                            .setPositiveButton(R.string.display_receive_redeem, new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    ...
                                    TextView showText = new TextView(PayNymRestoreActivity.this);
                                    showText.setText(redeemScript);
                                    showText.setTextIsSelectable(true);
                                    showText.setPadding(40, 10, 40, 10);
                                    showText.setTextSize(18.0f);

                                    new AlertDialog.Builder(PayNymRestoreActivity.this)
                                            .setTitle(R.string.app_name)
                                            .setView(showText)
                                            .setCancelable(false)
                            ...
                            .setNegativeButton(R.string.display_receive_privkey, new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    ...
                                    ImageView showQR = new ImageView(PayNymRestoreActivity.this);
                                    Bitmap bitmap = null;
                                    ...
                                    LinearLayout privkeyLayout = new LinearLayout(PayNymRestoreActivity.this);
                    ...
                    Toast.makeText(PayNymRestoreActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                }
    ...
    public void onResume() {
        super.onResume();
        AppUtil.getInstance(PayNymRestoreActivity.this).checkTimeOut();
    }
