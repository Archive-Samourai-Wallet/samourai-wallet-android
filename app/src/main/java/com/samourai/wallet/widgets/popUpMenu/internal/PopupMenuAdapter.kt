package com.samourai.wallet.widgets.popUpMenu.internal
...
import com.samourai.wallet.widgets.popUpMenu.MaterialPopupMenu
...
internal class PopupMenuAdapter(
    ...
    internal class ItemViewHolder(itemView: View, dismissPopupCallback: () -> Unit) : AbstractItemViewHolder(itemView, dismissPopupCallback) {
        ...
        private var icon: ShapeableImageView = itemView.findViewById(R.id.mpm_popup_menu_item_icon)
        ...
        override fun bindItem(popupMenuItem: MaterialPopupMenu.AbstractPopupMenuItem) {
            ...
            castedPopupMenuItem.iconShapeAppearance?.let {
                icon.shapeAppearanceModel = castedPopupMenuItem.iconShapeAppearance
            }
            val params =  icon.layoutParams
            if(params != null &&  castedPopupMenuItem.iconSize != null ){
                val size = itemView.context.resources.displayMetrics.density * castedPopupMenuItem.iconSize;
            ...
            if (castedPopupMenuItem.icon != 0 || castedPopupMenuItem.iconDrawable != null) {
                icon.apply {
                    ...
                    if (castedPopupMenuItem.iconColor != 0 && !castedPopupMenuItem.disableTint ) {
            ...
            if(castedPopupMenuItem.disableTint){
