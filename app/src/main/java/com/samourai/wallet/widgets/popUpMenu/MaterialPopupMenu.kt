package com.samourai.wallet.widgets.popUpMenu
...
import com.samourai.wallet.widgets.popUpMenu.internal.PopupMenuAdapter
...
internal constructor(
    ...
    private fun resolvePopupStyle(context: Context): Int {
        ...
        val resolvedStyle = a.getResourceId(0, R.style.Theme_Samourai_Widget_MPM_Menu)
        a.recycle()
    ...
    internal data class PopupMenuItem(
        ...
        val iconShapeAppearance: ShapeAppearanceModel? = null,
